...
import { toCanvasPx, fromCanvasPx, toCanvasWidth } from './util';
import {
  CANVAS_HEIGHT,
  CANVAS_WIDTH,
  RECT_WIDTH,
...
export default class Text extends React.Component {
  static propTypes = {
    ...
    updateActiveTextId: func.isRequired,
  ...
  handleRemoveText = () => {
    this.props.removeText(this.props.text.id);
  }

  handleDragEnd = () => {
    const { x, y } = fromCanvasPx(this.group.attrs.x, this.group.attrs.y);
    this.props.updateText({ x, y, id: this.props.text.id });
    this.props.onDragEnd();
  }

  handleClick = () => {
    if (this.props.editible) {
      this.props.updateActiveTextId(this.props.text.id);
