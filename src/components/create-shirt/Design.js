...
import { updateDesign, fetchDesigns, removeDesign } from '../../action';
import {
  toCanvasPx,
  fromCanvasPx,
  toCanvasHeight,
...
const { number, func, bool, object } = React.PropTypes;
...
class Design extends React.Component {
  static propTypes = {
    ...
    onChangeLayer: func.isRequired,
    fetchDesigns: func.isRequired,
    onDragEnd: func.isRequired,
    onDrag: func.isRequired,
    editible: bool,
    removeDesign: func.isRequired,
    design: object.isRequired,
    designs: object.isRequired,
  }
  ...
  componentDidMount() {
    ...
    rotateImg.src = '/image/rotate.svg';
    rotateImg.onload = () => {
      this.setState({
        rotateImg,
      });
  ...
  componentWillReceiveProps(nextProps) {
    const nextDesignId = nextProps.design.designId;
  ...
  handleDragEnd = () => {
    ...
    this.props.updateDesign({ id: this.props.design.id, x, y });
  ...
  handleResizeEnd = () => {
    ...
    this.props.updateDesign({ id: this.props.design.id, x, y, width, height });
    this.props.onDragEnd();
  }
  ...
  handleRemoveDesign = () => {
    this.props.removeDesign(this.props.design.id);
  }
